...
import { datosBien } from './datosBienSusceptible';

@Component({
  selector: 'sg-bienes-susceptibles',
  templateUrl: './bienes-susceptibles.component.html',
  styleUrls: ['./bienes-susceptibles.component.scss']
})
export class BienesSusceptiblesComponent {
  @Input() fecha: string = '';
