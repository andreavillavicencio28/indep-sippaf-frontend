...
export class SolicitudesComponent {
  ...
  abrirCamvasPrincipal(datos: any) {
    switch (this.Seleccionado) {
      case 8:
        this.datosNombramiento = datos;
        switch (this.datosNombramiento.tipoBien) {
          case 'Electrónico':
            this.nombramientoComponent.tipoNombramiento = 'productiva'
            break;
          case 'Mueble':
            this.nombramientoComponent.tipoNombramiento = 'comodato'
            break
          case 'Vehículo':
            this.nombramientoComponent.tipoNombramiento = 'blindado'
            break
          default:
            this.nombramientoComponent.tipoNombramiento = 'productiva'
            break;
